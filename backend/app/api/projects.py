...
Implemented endpoints: create (POST /), list (GET /), get (GET /{id}).
Planned (not yet implemented): update, archive, and delete. This module does
NOT provide full CRUD today.
"""
