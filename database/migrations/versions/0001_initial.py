...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("name_ar", sa.String(length=200)), sa.Column("cr_number", sa.String()),
...
op.create_table(
    ...
    sa.Column("size_bytes", sa.Integer()), sa.Column("storage_ref", sa.String(length=500)),
    *_ts(),
)
...
op.create_table(
    ...
    sa.Column("capex", sa.Float(), nullable=False), sa.Column("opex_annual", sa.Float(), nullable=False),
    sa.Column("revenue_year1", sa.Float(), nullable=False), sa.Column("growth_rate", sa.Float(), nullable=False),
    sa.Column("discount_rate", sa.Float(), nullable=False), sa.Column("horizon_years", sa.Integer(), nullable=False),
    *_ts(),
)
...
op.create_table(
    ...
    sa.Column("id", sa.Integer(), primary_key=True),
    sa.Column("study_id", sa.Integer(), sa.ForeignKey("feasibility_studies.id"), nullable=False),
    sa.Column("roi", sa.Float()), sa.Column("npv", sa.Float()),
    sa.Column("irr", sa.Float()), sa.Column("payback_years", sa.Float()),
    sa.Column("break_even", sa.Float()), sa.Column("verdict", sa.String()),
...
op.create_table(
    ...
    sa.Column("npv", sa.Float()), sa.Column("irr", sa.Float()),
    *_ts(),
)
...
op.create_table(
    ...
    sa.Column("locale", sa.String(), nullable=False), sa.Column("version", sa.String(), nullable=False),
...
op.create_table(
    ...
    sa.Column("description_en", sa.Text()), sa.Column("description_ar", sa.Text()),
    sa.Column("funding_type", sa.String()),
    sa.Column("eligibility", sa.JSON(), nullable=False),
    sa.Column("source_url", sa.String(length=500)), sa.Column("application_url", sa.String(length=500)),
...
op.create_table(
    ...
    sa.Column("reasons", sa.JSON(), nullable=False), sa.Column("missing", sa.JSON(), nullable=False),
    *_ts(),
)
...
op.create_table(
    ...
    sa.Column("industry", sa.String(length=100), nullable=False),
    sa.Column("summary_en", sa.Text()), sa.Column("summary_ar", sa.Text()),
    sa.Column("problem", sa.Text()), sa.Column("solution", sa.Text()),
    sa.Column("revenue_model", sa.String(length=200)),
    sa.Column("investment_min", sa.Float()), sa.Column("investment_max", sa.Float()),
    sa.Column("difficulty", sa.String()), sa.Column("time_to_launch", sa.String()),
...
op.create_table(
    ...
    sa.Column("royalty_model", sa.String(length=150)), sa.Column("required_space", sa.String(length=100)),
    sa.Column("application_url", sa.String(length=500)), sa.Column("source_url", sa.String(length=500)),
    sa.Column("verification_status", sa.String(), nullable=False),
    sa.Column("is_active", sa.Boolean(), nullable=False),
    *_ts(),
)
...
op.create_table(
    ...
    sa.Column("asking_price", sa.Float()), sa.Column("reserve_price", sa.Float()),
...
op.create_table(
    ...
    sa.Column("entity", sa.String(length=100)), sa.Column("entity_id", sa.Integer()),
