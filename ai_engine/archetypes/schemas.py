...
FNB_SCHEMA = [
    ...
    _f(
        ...
        unit="SAR",
        required=False,
        description_en="Espresso, grinders, refrigeration, etc.",
        description_ar="آلات الإسبريسو، المطاحن، التبريد، إلخ.",
    ),
    _f(
        "other_capex",
        label_en="Furniture / POS / opening CAPEX",
        label_ar="أثاث / نقاط البيع / نفقات الافتتاح",
        input_type="currency",
        unit="SAR",
        required=False,
        description_en="Furniture, POS, smallwares, and other opening package costs.",
        description_ar="الأثاث ونقاط البيع ومستلزمات الافتتاح الأخرى.",
    ),
