...
DOMAIN_CLASSES: dict[str, DomainClass] = {
    ...
    "job_salary": DomainClass(
        ...
        domains=(
            ...
            # Reachable role-salary aggregators when Bayt/Indeed return 403.
            "payscale.com",
            "www.payscale.com",
            "talent.com",
            "www.talent.com",
    ...
    "fitout_vendor": DomainClass(
        ...
        domains=(
            ...
            "extra.com",
            "www.extra.com",
            # Saudi commercial fit-out contractor quotes (SAR/m²).
            "archskills.com",
            "www.archskills.com",
        ),
        allow_discovered_hosts=True,
    ...
    "market_report": DomainClass(
        ...
        domains=(
            ...
            "www.stats.gov.sa",
            "stats.gov.sa",
            # Reachable F&B operating benchmarks / local price surveys.
            "squareup.com",
            "www.squareup.com",
            "square.com",
            "www.square.com",
            ...
            "www.shifty-app.com",
            "bravecalculator.com",
            "www.bravecalculator.com",
            "explore-saudi.com",
            "www.explore-saudi.com",
            "rimthancoffee.com",
            "www.rimthancoffee.com",
            "drcafe.com",
            "www.drcafe.com",
        ),
        allow_discovered_hosts=True,
